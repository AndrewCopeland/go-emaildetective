...
// APIClient manages communication with the api.emaildetective.io API API v1.0.0
...
type APIClient struct {
	...
	EmailInfoAPI *EmailInfoAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.EmailInfoAPI = (*EmailInfoAPIService)(&c.common)
